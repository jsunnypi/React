...
app.post("/insert",(req,res)=>{
    ...
    const sqlQuery="insert into board(board_title,board_content,register_id) values(?,?,'atristJoy');";
...
app.post("/update",(req,res)=>{
    ...
    var content = req.body.content;
    var id = req.body.id;
    const sqlQuery="update board set board_title=?, board_content=?, updater_date=now() where board_id = ?;";
